...
```
$ ./multi.py -n 4 -M 100 -L 1:100:50,2:100:150
```
...
Probably the best to learn about are some of the tracing options (like `-t`,
`-T`, `-C`, and `-S`). Play around with these to see better what the scheduler
and system are doing.
